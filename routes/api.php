...
Route::group(['middleware' => ['auth:api', 'verify.data.access']], function () {
    ...
    Route::get('phc-workers/by-id', [PhcWorkerController::class, 'getById'])->middleware('role:access_all');
    ...
    Route::name('admin.')->group(function () {
        ...
        Route::get('health-condition-group', [ForwarderController::class, 'index'])->middleware('role:view_health_condition');
        Route::get('health-condition', [ForwarderController::class, 'index'])->middleware('role:view_health_condition');
